...
namespace ElementareTeilchen\Siteloader\TypoScript;
        ...
        foreach ($rootLine as $level => $pageRecord) {
            ...
            if ($package !== null) {
                ...
                $fakeRow = [
                    ...
                    'uid' => 'sys_siteloader_' . (int)$pageRecord['uid'] . $package->getPackageKey(),
                    'title' => $package->getPackageKey(),
                    // make this the root template
                    'root' => !$hasRootTemplate,
                ];
                $templateService->processTemplate($fakeRow, 'sys_siteloader_' . $package->getPackageKey(), (int)$pageRecord['uid'], 'sys_siteloader_' . $package->getPackageKey());
